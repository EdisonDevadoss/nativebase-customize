...
export default {
  ...
  // Roboto_medium
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'Ageo Personal Use',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'Ageo Personal Use',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : 'Ageo Personal Use',
